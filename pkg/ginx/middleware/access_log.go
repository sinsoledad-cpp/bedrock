...
func NewAccessLogBuilder(logFn func(ctx context.Context, l AccessLog)) *AccessLogBuilder {
	return &AccessLogBuilder{
		logFn: logFn,
	}
}

func (l *AccessLogBuilder) AllowReqBody() *AccessLogBuilder {
	l.allowReqBody = true
	return l
}

func (l *AccessLogBuilder) AllowRespBody() *AccessLogBuilder {
	l.allowRespBody = true
	return l
}

func (l *AccessLogBuilder) Build() gin.HandlerFunc {
